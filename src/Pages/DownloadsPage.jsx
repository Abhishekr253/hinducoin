    ...
    <main className="w-full text-white bg-[#05070C]">
          ...
          <motion.div variants={fadeUp}>
            <LuxuryCard>
              <p className="text-white/60 text-center">
                Minimum and recommended specifications will be announced
                closer to the public release.
              </p>
            </LuxuryCard>
          </motion.div>
        </motion.div>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <LuxuryCard>
            <p className="text-white/50 text-sm">
              No public patches available yet.
              Updates will be documented here following the initial release.
            </p>
          </LuxuryCard>
        </motion.div>
      </section>
